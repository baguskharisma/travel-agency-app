    ...
    <section class="px-8 mx-auto bg-white shadow-lg w-85 h-72 rounded-2xl -mt-36">
        <div class="flex items-center mb-4">
            <div class="flex items-center justify-center h-16 border-b-4 border-mint-green">
                ...
                <a href="#" class="font-semibold text-md font-montserrat">Flights</a>
            </div>
            <div class="h-12 mx-8 border border-l border-[#D7E2EE]"></div>
            <div class="flex items-center justify-center h-24 border-b-4 border-transparent">
                <svg class="mr-2" width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <form class="flex items-center mb-6 space-x-6" action="">
            <div class="flex relative flex-col w-[30%] mb-4">
                ...
                <div class="absolute inset-y-0 right-0 flex items-center mt-2 mr-4">
            ...
            <div class="flex relative flex-col w-[10%] mb-4">
                ...
                <input type="text"
                    class="w-full px-3 py-4 rounded border-fade-gray placeholder:font-montserrat placeholder:text-fade-black placeholder:text-base"
                    placeholder="Return">
                <div class="absolute inset-y-0 right-0 flex items-center mt-2 mr-4">
        ...
        <div class="flex items-center px-5 py-6 mt-4 space-x-12 overflow-hidden ms-20">
            <div class="relative">
                ...
                <div class="relative z-10 p-6 bg-white rounded-lg shadow-lg review-card">
                    ...
                    <div class="flex justify-end mb-4">
                        <a class="text-sm font-bold font-trade-gothic" href="#">View more</a>
                    </div>
                    ...
                    <p class="mb-1 text-sm font-bold font-trade-gothic text-blackish-green">Olga</p>
                    <p class="mb-3 text-xs font-medium font-montserrat">Weave Studios - Kai Tak</p>
                    <div class="flex items-center mb-10 space-x-2">
                        ...
                        <span class="text-xs font-bold font-trade-gothic text-blackish-green">Google</span>
                    </div>
            ...
            <div class="relative">
                ...
                <div class="relative z-10 p-6 bg-white rounded-lg shadow-lg review-card">
                    ...
                    <p class="mb-1 text-sm font-bold font-trade-gothic text-blackish-green">Thomas</p>
                    <p class="mb-3 text-xs font-medium font-montserrat">Weave Studios - Olympic</p>
                    <div class="flex items-center mb-10 space-x-2">
                        <span>
                            <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <div class="relative">
                ...
                <div class="relative z-10 p-6 bg-white rounded-lg shadow-lg review-card">
                    ...
                    <p class="mb-1 text-sm font-bold font-trade-gothic text-blackish-green">Eliot</p>
                    <p class="mb-3 text-xs font-medium font-montserrat">Weave Studios - Kai Tak</p>
                    <div class="flex items-center mb-10 space-x-2">
                        <span>
                            <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
