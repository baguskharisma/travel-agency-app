<div>
    <nav class="mx-auto px-16 pt-20 flex justify-between items-center h-24">
        <div class="flex items-center">
            ...
            <div class="h-24 w-32 border-b-4 border-transparent flex items-center justify-center">
                <svg class="mr-2 fill-white" width="22" height="18" fill="none"
